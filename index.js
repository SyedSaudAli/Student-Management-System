...
if (courseFee === paymentAmount) {
    ...
    if (viewAndExit.information === "View") {
        console.log(chalk.bold.bgCyan.whiteBright(`\tCongratulations, ${answers.students} you have purchased this course.\n`));
        ...
        console.log(chalk.green(`Balance: ${chalk.bold.underline(studBalance + paymentAmount)}`));
    }
    else {
